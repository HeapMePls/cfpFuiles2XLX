...
class Patient(Document):
	...
	@frappe.whitelist()
	def admit(self, service_unit, check_in, orden_medica, indicaciones_al_ingreso):
		inpatient_record = create_inpatient_record(self, service_unit, check_in, orden_medica, indicaciones_al_ingreso)
		update_patient_status(self, inpatient_record)
